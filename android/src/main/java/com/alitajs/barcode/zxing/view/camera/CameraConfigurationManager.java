...
package com.alitajs.barcode.zxing.view.camera;
...
final class CameraConfigurationManager {
	...
	void setDesiredCameraParameters(Camera camera, boolean safeMode) {
		...
		CameraConfigurationUtils.setFocus(parameters, prefs.getBoolean(
				PreferencesConstant.KEY_AUTO_FOCUS, true), prefs.getBoolean(
				PreferencesConstant.KEY_DISABLE_CONTINUOUS_FOCUS, true),
				safeMode);
